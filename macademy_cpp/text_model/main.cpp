...
class MnistTrainerApp : public ConsoleApp
{
    ...
    static void LoadTextData(std::vector<TrainingData>& training_data_vector, const std::string& img_filename, const std::string& label_filename)
    {
  ...
  public:
    MnistTrainerApp(const std::string& data_folder)
    {
        ...
        layers.emplace_back(macademy::LayerConfig{.m_activation = macademy::ActivationFunction::Sigmoid, .m_num_neurons = 512});
