...
namespace macademy
{
    struct TrainingData
    {
        ...
        std::vector<float> m_desired_output; ///< The desired output values to the given input. The number of elements in this vector must match the number of neurons in the last (outout) layer of the trained network!
    };
