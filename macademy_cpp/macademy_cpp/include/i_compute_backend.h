...
class IComputeDevice
{
  public:
    ...
    virtual void ApplyRandomMutation(const NetworkResourceHandle& network_handle, MutationDistribution weight_mutation_distribution, MutationDistribution bias_mutation_distribution) = 0;
