...
__kernel void evaluateLayerBatched(__global const float* weights_biases,
                                   ...
                                   const uint current_layer_id,
                                   const ulong current_layer_weights_offset)
{
                                  ...
                                  )
{
    ...
    __global const float* prevActivations = current_layer_id == 0 ?
                                   ...
                                   )
{
    ...
    __global float* neuron_gradient_data = gradient + current_layer_weights_offset + layer_neuron_id * (weights_per_neuron + 1);
